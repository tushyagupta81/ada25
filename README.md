...
- [x] Quicksort
    ...
    ![Quicksort algo time graph](https://github.com/tushyagupta81/ada25/tree/main/plot/graphs/quicksort.png)
...
- [x] Magic square(odd size) - Sum of all rows, columns and diagonals is equals
    ...
    ![Magic Square algo time graph](https://github.com/tushyagupta81/ada25/tree/main/plot/graphs/magic_square.png)
- [x] Cosine Similarity
...
- [x] Fractional Knapsack
    ...
    ![Knapsack algo time graph](https://github.com/tushyagupta82/ada25/tree/main/plot/graphs/knapsack.png)
